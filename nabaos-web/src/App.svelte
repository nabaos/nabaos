<script lang="ts">
  ...
  import { appState, navigateTo, toastState, dismissToast, type Page } from './lib/stores.svelte';
  ...
  import Outputs from './routes/Outputs.svelte';
  ...
  <div class="app-layout">
    <aside class="sidebar">
      ...
      <nav>
        {#each navItems as item}
          <button class={appState.page === item.id ? 'active' : ''} onclick={() => navigateTo(item.id)}>
            {#if item.id === 'chat'}
    ...
    <main class="main-content">
      ...
      {:else if appState.page === 'dashboard'}
        <Dashboard />
      {:else if appState.page === 'pea'}
        <Pea />
      {:else if appState.page === 'outputs'}
        <Outputs />
      {:else if appState.page === 'workflows'}
        <Workflows />
      {:else if appState.page === 'watcher'}
        <Watcher />
